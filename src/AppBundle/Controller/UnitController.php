...
class UnitController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_unit_show', array('id' => $unit->getId()));
        }
     ...
     *
     * @Route("/{id}/edit", name="admin_unit_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Unit $unit)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_unit_edit', array('id' => $unit->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_unit_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Unit $unit)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_unit_delete', array('id' => $unit->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
